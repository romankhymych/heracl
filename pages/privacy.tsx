    ...
    <>
      ...
      <Accordion>
        <Accordion.Item value="summaryOfKeyPoints">
          <Accordion.Control>
            {en.privacy.summaryOfKeyPoints.title}
          </Accordion.Control>
          <Accordion.Panel>
            <Text component="p">
              {en.privacy.summaryOfKeyPoints.description}
            </Text>
            <Text component="p">
              {
                en.privacy.summaryOfKeyPoints.personalInformationProcessing
                  .title
              }
            </Text>
            <Text component="p">
            ...
            <Text component="p">
              {
                en.privacy.summaryOfKeyPoints
                  .sensitivePersonalInformationProcessing.title
              }
            </Text>
            <Text component="p">
              {
                en.privacy.summaryOfKeyPoints
                  .sensitivePersonalInformationProcessing.content
              }
            </Text>
            <Text component="p">
              {
                en.privacy.summaryOfKeyPoints.thirdPartyInformationReceiving
                  .title
              }
            </Text>
            <Text component="p">
            ...
            <Text component="p">
              {
                en.privacy.summaryOfKeyPoints.informationProcessingMethods
                  .content
              }
            </Text>
            <Text component="p">
            ...
            <Text component="p">
              {en.privacy.summaryOfKeyPoints.informationSecurity.title}
            </Text>
            <Text component="p">
              {en.privacy.summaryOfKeyPoints.informationSecurity.content}
            </Text>
            <Text component="p">
              {en.privacy.summaryOfKeyPoints.yourPrivacyRights.title}
            </Text>
            <Text component="p">
              {en.privacy.summaryOfKeyPoints.yourPrivacyRights.content}
            </Text>
            <Text component="p">
              {en.privacy.summaryOfKeyPoints.rightsExercise.title}
            </Text>
            <Text component="p">
              {en.privacy.summaryOfKeyPoints.rightsExercise.content}
            </Text>
            <Text component="p">
              {en.privacy.summaryOfKeyPoints.fullNoticeReview.title}
            </Text>
            <Text component="p">
              {en.privacy.summaryOfKeyPoints.fullNoticeReview.content}
            </Text>
          </Accordion.Panel>
        </Accordion.Item>
        <Accordion.Item value="whatInformationDoWeCollect">
          <Accordion.Control>
            {en.privacy.whatInformationDoWeCollect.title}
          </Accordion.Control>
          <Accordion.Panel>
            <Text component="p">
              {
                en.privacy.whatInformationDoWeCollect
                  .personalInformationYouDiscloseToUs
              }
            </Text>
            <Text component="p">
              {en.privacy.whatInformationDoWeCollect.inShort}
            </Text>
            <Text component="p">
              {en.privacy.whatInformationDoWeCollect.description}
            </Text>
            <Text component="p">
              {
                en.privacy.whatInformationDoWeCollect
                  .personalInformationProvidedByYou.title
              }
            </Text>
            <Text component="p">
              {
                en.privacy.whatInformationDoWeCollect
                  .personalInformationProvidedByYou.content
              }
            </Text>
            <List>
              {en.privacy.whatInformationDoWeCollect.bullets.map(
                (bullet, index) => (
                  <List.Item key={index}>{bullet}</List.Item>
                )
              )}
            ...
            <Text component="p">
              {
                en.privacy.whatInformationDoWeCollect.sensitiveInformation
                  .content
              }
            </Text>
            <Text component="p">
        ...
        <Accordion.Item value="Rest">
          ...
          <Accordion.Panel>
            <Text component="p">
              ...
              Services, including: To save or protect an individual&apos;s vital
              interest. We may process your information when necessary to save
              ...
              2/6 26/02/2023, 23:57 Termly 3. WHAT LEGAL BASES DO WE RELY ON TO
              PROCESS YOUR INFORMATION? In Short: We only process your personal
              ...
              interests. If you are located in the EU or UK, this section
              applies to you. The General Data Protection Regulation (GDPR) and
              UK GDPR require us to explain the valid legal bases we rely on in
              order to process your personal information. As such, we may rely
              ...
              here to learn more. Legal Obligations. We may process your
              ...
              are involved. Vital Interests. We may process your information
              ...
              involving potential threats to the safety of any person. If you
              are located in Canada, this section applies to you. We may process
              ...
              Click here to learn more. In some exceptional cases, we may be
              legally permitted under applicable law to process your information
              without your consent, including, for example: If collection is
              clearly in the interests of an individual and consent cannot be
              obtained in a timely way For investigations and fraud detection
              and prevention For business transactions provided certain
              conditions are met If it is contained in a witness statement and
              the collection is necessary to assess, process, or settle an
              insurance claim For identifying injured, ill, or deceased persons
              and communicating with next of kin If we have reasonable grounds
              to believe an individual has been, is, or may be victim of
              financial abuse If it is reasonable to expect collection and use
              with consent would compromise the availability or the accuracy of
              the information and the collection is reasonable for purposes
              ...
              purposes for which the information was produced If the collection
              is solely for journalistic, artistic, or literary purposes If the
              information is publicly available and is specified by the
              regulations 4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL
              INFORMATION?
              https://app.termly.io/dashboard/website/5c488eba-fc38-4cd6-b199-ae07564ef961/privacy-policy
              3/6 26/02/2023, 23:57 Termly In Short: We may share information in
              specific situations described in this section and/or with the
              following third parties. We may need to share your personal
              information in the following situations: Business Transfers. We
              may share or transfer your information in connection with, or
              during negotiations of, any merger, sale of company assets,
              financing, or acquisition of all or a portion of our business to
              another company. 5. HOW LONG DO WE KEEP YOUR INFORMATION? In
              Short: We keep your information for as long as necessary to fulfil
              the purposes outlined in this privacy notice unless otherwise
              required by law. We will only keep your personal information for
              as long as it is necessary for the purposes set out in this
              ...
              deletion is possible. 6. HOW DO WE KEEP YOUR INFORMATION SAFE? In
              ...
              secure environment. 7. DO WE COLLECT INFORMATION FROM MINORS? In
              ...
              market to children under 18 years of age. By using the Services,
              ...
              us at privacy@heracl.com. 8. WHAT ARE YOUR PRIVACY RIGHTS? In
              Short: In some regions, such as the European Economic Area (EEA),
              ...
              regions (like the EEA, UK, and Canada), you have certain rights
              ...
              https://app.termly.io/dashboard/website/5c488eba-fc38-4cd6-b199-ae07564ef961/privacy-policy
              4/6 26/02/2023, 23:57 Termly We will consider and act upon any
              request in accordance with applicable data protection laws. If you
              are located in the EEA or UK and you believe we are unlawfully
              ...
              grounds other than consent. If you have questions or comments
              about your privacy rights, you may email us at privacy@heracl.com.
              ...
              online browsing activities monitored and collected. At this stage
              no uniform technology standard for recognising and implementing
              ...
              version of this privacy notice. 10. DO CALIFORNIA RESIDENTS HAVE
              ...
              your personal information. California Civil Code Section 1798.83,
              also known as the &apos;Shine The Light&apos; law, permits our
              ...
              (e.g. backups, etc.). 11. DO WE MAKE UPDATES TO THIS NOTICE? In
              Short: Yes, we will update this notice as necessary to stay
              compliant with relevant laws.
              https://app.termly.io/dashboard/website/5c488eba-fc38-4cd6-b199-ae07564ef961/privacy-policy
              5/6 26/02/2023, 23:57 Termly We may update this privacy notice
              from time to time. The updated version will be indicated by an
              updated &apos;Revised&apos; date and the updated version will be
              effective as soon as it is accessible. If we make material changes
              ...
              information. 12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE? If you
              have questions or comments about this notice, you may email us at
              privacy@heracl.com or by post to: HERACL Roman Khymych Krynicka 3
              Gdansk, Pomeranian 80-393 Poland 13. HOW CAN YOU REVIEW, UPDATE,
              OR DELETE THE DATA WE COLLECT FROM YOU? Based on the applicable
              laws of your country, you may have the right to request access to
              the personal information we collect from you, change that
